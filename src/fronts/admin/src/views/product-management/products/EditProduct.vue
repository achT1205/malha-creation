...
const storedProduct = computed(() => productStore.product);
...
watch(storedProduct, (newValue, oldValue) => {
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        ...
                        <Select id="productType" :disabled="product.id !== ''" :options="productTypes"
                            v-model="product.productType" optionLabel="name" optionValue="id"
                                    ...
                                    <TabPanel v-slot="slotProps"
                                        ...
                                        <div v-show="slotProps.active" :class="slotProps.class"
                                            ...
                                            <Fieldset>
                                                ...
                                                <div class="col-span-12">
                                                    <MultiSelect id="outfit" :options="colorVariants" filter
                                                        v-model="colorVariant.outfitIds" optionLabel="slug"
                                                        optionValue="id" placeholder="Select an Outfit" display="chip"
                                                        :maxSelectedLabels="3" class="w-full md:w-30rem"
                                                        :optionDisabled="(option) => isOptionDisabled(option, colorVariant)">
