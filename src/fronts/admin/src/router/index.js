...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import('@/views/product-management/products/ProductList.vue')
            },
            {
                path: '/product-anagement/parameters/categories',
                name: 'categories',
                meta: {
                    breadcrumb: ['Product Management', 'Categories']
                },
                component: () => import('@/views/product-management/categories/Categories.vue')
            },
            {
                path: '/product-anagement/parameters/brands',
                name: 'brands',
                meta: {
                    breadcrumb: ['Product Management', 'Brands']
                },
                component: () => import('@/views/product-management/brands/Brands.vue')
            },
            {
                path: '/product-anagement/parameters/occasions',
                name: 'occasions',
                meta: {
                    breadcrumb: ['Product Management', 'Occasions']
                },
                component: () => import('@/views/product-management/occasions/Occasions.vue')
            },
            {
                path: '/product-anagement/parameters/materials',
                name: 'materials',
                meta: {
                    breadcrumb: ['Product Management', 'Materials']
                },
                component: () => import('@/views/product-management/materials/Materials.vue')
            },
            {
                path: '/product-anagement/parameters/collections',
                name: 'collections',
                meta: {
                    breadcrumb: ['Product Management', 'Collections']
                },
                component: () => import('@/views/product-management/collections/Collections.vue')
            },
